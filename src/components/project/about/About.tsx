  ...
  return (
    <div className="mx-16 pr-16 text-white flex w-full h-screen relative border-l-[1px]" id="about">
      ...
      <div className="flex flex-col w-full h-full items-start justify-center text-left px-[15%]">
        <h3 className="font[600px] text-[30px] leading-[168%] tracking-[0.13em] mb-10 uppercase">{about.title_firstPart} <span className="block">{about.title_secondPart}</span></h3>
        <div className="flex w-full h-auto items-center justify-between">
            ...
            <div className="w-[400px] h-[230px] relative">
                ...
                <   Image className=" w-full h-full " src={about.images.link_1} alt={'converse'} width={340} height={200}/>
                </div>
                <div className=" absolute w-[340px] h-[200px] z-20 left-[30px] top-[30px]">
                    <Image className=" w-full h-full " src={about.images.link_2} alt={'converse'} width={340} height={200}/>
                </div>
